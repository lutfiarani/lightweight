...
Route::middleware(['auth', 'role:prod'])->group(function () {
...
Route::middleware(['auth', 'role:dev'])->controller(MasterController::class)->group(function () {
...
Route::middleware(['auth', 'role:dev'])->controller(ProductWeightController::class)->group(function () {
...
Route::middleware(['auth', 'role:dev'])->controller(WeightListController::class)->group(function () {
...
Route::middleware(['auth', 'role:dev'])->controller(PercentageController::class)->group( function() {
...
// })->middleware(['auth', 'role:dev'])->name('register');

Route::post('/register', [RegisteredUserController::class, 'store'])->middleware(['auth', 'role:dev']);
